...
--[[ COMMANDE RAJOUTER ]]
RegisterCommand('gethudstatus', function()
    print('------------------------------------------')
    print('[x-hud] HUD - FAIM   :', statuses.hunger or 'nil')
    print('[x-hud] HUD - SOIF   :', statuses.thirst or 'nil')
    print('[x-hud] HUD - STRESS :', statuses.stress or 'nil')
    print('[x-hud] HUD - ARMURE :', statuses.armor or 'nil')
    print('------------------------------------------')
end)

--[[ COMMANDE RAJOUTER ]]
RegisterCommand('givearmor4', function()
    local ped = PlayerPedId()
    SetPedArmour(ped, 100)
    print('[TEST] Armure GTA appliquée à 100.')
end)
