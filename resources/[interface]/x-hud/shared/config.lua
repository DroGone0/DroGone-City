...
Config.Framework = "esx" -- "esx-ox" or "qbx" or "esx" or "qb" (you can easily add any other framework by heading to modules=>bridge)
...
Config.EnableStressOnSpeeding = false            -- whether this script should run its built-in vehicle speed monitoring to increase stress periodically (it requires Config.EnableSeatbelt to be "true")
...
Config.GainStressWhileShooting = false           -- whether this script should increase player stress while shooting
