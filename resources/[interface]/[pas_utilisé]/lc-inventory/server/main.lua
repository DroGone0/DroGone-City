...
RegisterCommand('giveitem', function(source, args)
    ...
    if item then
        ...
        showNotification(xPlayer, "Tu as reçu ~g~"..count.."~s~x "..item)
        TriggerClientEvent('lgd_inv:refreshInventory', source) -- <-- Ajoute cette ligne
    else
        showNotification(xPlayer, "~r~Usage: /giveitem [nom_item] [quantité]")
    end
end)
